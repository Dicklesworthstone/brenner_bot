      ...
      <section className="space-y-6">
        <div className="p-6 rounded-2xl bg-gradient-to-br from-primary/5 via-primary/10 to-accent/5 border border-primary/20">
          ...
          <p className="text-muted-foreground leading-relaxed mb-4">
            <strong className="text-foreground">Sydney Brenner</strong> (1927-2019) was one of the
            most successful experimental biologists in history. He won the Nobel Prize for his work
            on programmed cell death and helped decode the genetic code. But his <em>method</em> is
            more valuable than any single discovery.
          </p>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                The world is produced by causal machinery with discoverable rules. Phenomena
                aren&apos;t random — they&apos;re generated by underlying mechanisms that we can
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                ...
                Description isn&apos;t explanation — you need to specify the mechanism that produces
                the phenomenon.
              </p>
            </motion.div>
          </div>
        ...
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground">
            By the end of this tutorial, you&apos;ll have a{" "}
            <strong className="text-foreground">research artifact</strong> for your own scientific
            question. Here&apos;s what it contains:
          </p>
...
...`}
        ...
        <div className="p-4 rounded-xl border border-border bg-card/50">
          <p className="text-sm text-muted-foreground">
            <strong className="text-foreground">Next up:</strong> In Step 2, you&apos;ll verify your
            prerequisites — Git, terminal access, and Bun. It only takes a couple of minutes.
          </p>
        </div>
      </section>
    </TutorialStep>
